                ...
                <div class="content">
                    <div class="container">
                            ...
                            <div class="botoes mt-25 mb-20">                                          
                                ...
                                <a href="<?php echo base_url('inseriravaliacaocorporal/') . 
                            ...
                            <div class="tab-content row-fluid">
                                <div id="home" class="tab-pane fade in active">
                                    ...
                                    <div class="span12">
                                        <h2>Fichas de avaliação corporal</h2>
                                                ...
                                                <div>
                                                    <div class="panel-box">
                                                        <?php  
                                                            ...
                                                            foreach($listaravaliacaocorporal as $listaavaliacaocorporal){
                                                                $id = $listaavaliacaocorporal->id_ficha_avaliacao_corporal;
                                                                $data = $listaavaliacaocorporal->data;
                                                                $nome_usuario = $listaavaliacaocorporal->nome_profissional;
                                                                foreach($dadosclientes as $dadocliente){
                                                                    $opcoes = anchor(base_url('visualizaravaliacaocorporal/'. $dadocliente->id_cliente.'/'. limpar($dadocliente->nome_cliente)).'/'. $listaavaliacaocorporal->id_ficha_avaliacao_corporal,'<i data-toggle="tooltip" title="visualizar" class="fa fa-eye"></i>');
                                                                }
