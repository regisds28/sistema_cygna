...
class Alterarclientes extends CI_Controller {
    ...
    public function __construct(){
        ...
        $this->load->model('alterarclientes_model','modelalterarclientes');
	...
	public function index()
	{
        ...
        $dados['titulo'] =  'Alterar clientes';
        $dados['listaestados'] = $this->modelalterarclientes->lista_estados();
        $this->load->view('frontend/template/html-header', $dados);
        $this->load->view('frontend/template/topo');
        $this->load->view('frontend/template/aside');
		$this->load->view('frontend/alterarclientes');
    ...
    public function alterar($id_cliente){
        ...
        $this->load->model('alterarclientes_model','modelalterarclientes');
        $dados['alterarclientes'] =  $this->modelalterarclientes->listar_clientes($id_cliente);
        $dados['titulo'] =  'Alterar clientes';
    ...
    public function salvar_alteracoes(){
        ...
        if($this->form_validation->run() == FALSE){
            ...
            if($this->modelcadastroclientes->alterar($nome,$cpf,$dtnascimento,$idade,$sexo,$endereco,$cidade,$estado,$cep,$telefoneres,
